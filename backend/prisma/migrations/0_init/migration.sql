...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('VENTE', 'DEPENSE', 'RETRAIT', 'DEPOT', 'REMBOURSEMENT');
...
-- CreateEnum
CREATE TYPE "CertType" AS ENUM ('JOURNAL', 'COMPTE_DE_RESULTAT', 'BILAN', 'DECLARATION_TS', 'BORDEREAU_VERSEMENT');
