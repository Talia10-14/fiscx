...
const Nav = () => (
  <nav style={{
    ...
    <div style={{display:"flex",gap:10,alignItems:"center"}}>
      ...
      <Btn variant="primary" href="/signup">Télécharger l'app</Btn>
    </div>
  </nav>
);
  ...
  <section style={{
    ...
    <div>
      ...
      <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:40}}>
        <Btn variant="primary" size="xl" href="/signup">Commencer gratuitement</Btn>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,maxWidth:700,margin:"0 auto"}}>
      <Reveal>
        <div style={{background:C.white,border:`1px solid ${C.gray2}`,borderRadius:20,padding:"32px 28px"}}>
          ...
          <Btn variant="ghost" href="/signup" style={{width:"100%",justifyContent:"center"}}>Commencer</Btn>
        </div>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <div style={{background:C.green,borderRadius:20,padding:"32px 28px",position:"relative"}}>
          ...
          <Btn variant="gold" href="/signup" style={{width:"100%",justifyContent:"center"}}>Passer au Pro</Btn>
        </div>
      </Reveal>
    </div>
  </section>
...
const CtaFinal = () => (
  <section style={{background:C.green,textAlign:"center",padding:"120px 5vw"}}>
    ...
    <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
      <Btn variant="white" size="xl" href="/signup">⬇ Télécharger sur Android</Btn>
      <Btn variant="outlineWhite" size="xl" href="#comment">Voir une démo</Btn>
    </div>
